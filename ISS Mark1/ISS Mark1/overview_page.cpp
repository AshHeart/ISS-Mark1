...
void overviewScn(void)
{
	...
	glPushMatrix();
		...
		//Node 1 Unity
		glPushMatrix();
			glTranslatef(-3.2, 0.0, -150.0);
			gluCylinder(Labs, 3, 3, 5, 60, 10);
		glPopMatrix();

		//U.S. Lab Destiny
		glPushMatrix();
			glTranslatef(-3.2, 0.0, -144.0);
			gluCylinder(Labs, 3, 3, 6.5, 60, 10);
		glPopMatrix();

		//Node 2 Harmony
		glPushMatrix();
			glTranslatef(-3.2, 0.0, -138.0);
			gluCylinder(Labs, 3, 3, 5, 60, 10);
		glPopMatrix();

 		//JEM Kibo (Hope)
		glPushMatrix();
			glTranslatef(-0.0, 0.0, -138.0);
			glRotatef(90, 0.0, 1.0, 0.0);
